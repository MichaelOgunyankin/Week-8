...
const smMenuLinks = document.querySelectorAll('.main-header-sm-menu-link')
const smMenuLink1 = document.querySelector('.main-header-sm-menu-link--1')
const smMenuLink2 = document.querySelector('.main-header-sm-menu-link--2')
const smMenuLink3 = document.querySelector('.main-header-sm-menu-link--3')
const smMenuLink4 = document.querySelector('.main-header-sm-menu-link--4')
...
smMenuBtn.addEventListener('click', () => {
  ...
  smMenu.classList.add('main-header-sm-menu-active')
...
smMenuLinks.forEach((ele) => {
  ele.addEventListener('click', () => {
    ...
    smMenu.classList.remove('main-header-sm-menu--active')
...
function openFileInNewTab() {
  window.open('Assets/CV 2024.docx', '_blank');
}

cvButton.addEventListener('click', openFileInNewTab())